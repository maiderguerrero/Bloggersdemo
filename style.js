...
/***/ "./bloggersdemo/blink-src/js/cke_styles.js":
/*!********************************************!*\
  !*** ./bloggersdemo/blink-src/js/cke_styles.js ***!
  \********************************************/
...
const ckeStyles = [
  ...
  { name: 'Caja 10', type: 'widget', widget: 'blink_box', attributes: {'class': 'box-10' } },
  ...
  { name: 'Énfasis 2', element: 'span', attributes: {'class': 'enfasis-2' } },
  { name: 'Énfasis 3', element: 'span', attributes: {'class': 'enfasis-3' } },
  { name: 'Énfasis 4', element: 'span', attributes: {'class': 'enfasis-4' } },
  { name: 'Énfasis 5', element: 'span', attributes: {'class': 'enfasis-5' } },
  { name: 'Énfasis 6', element: 'span', attributes: {'class': 'enfasis-6' } },
  { name: 'Énfasis 7', element: 'span', attributes: {'class': 'enfasis-7' } },
  { name: 'Énfasis 8', element: 'span', attributes: {'class': 'enfasis-8' } },
  { name: 'Énfasis 9', element: 'span', attributes: {'class': 'enfasis-9' } },
  { name: 'Énfasis 10', element: 'span', attributes: {'class': 'enfasis-10' } },
  { name: 'Énfasis 11', element: 'span', attributes: {'class': 'enfasis-11' } },
  { name: 'Énfasis 12', element: 'span', attributes: {'class': 'enfasis-12' } },
  { name: 'Énfasis 13', element: 'span', attributes: {'class': 'enfasis-13' } },
  { name: 'Énfasis 14', element: 'span', attributes: {'class': 'enfasis-14' } },
  { name: 'Énfasis 15', element: 'span', attributes: {'class': 'enfasis-15' } },
  { name: 'Énfasis 16', element: 'span', attributes: {'class': 'enfasis-16' } },
  { name: 'Énfasis 17', element: 'span', attributes: {'class': 'enfasis-17' } },
  { name: 'Énfasis 18', element: 'span', attributes: {'class': 'enfasis-18' } },
  { name: 'Énfasis 19', element: 'span', attributes: {'class': 'enfasis-19' } },
  ...
  { name: 'Tabla 4', element: 'table', attributes: {'class': 'tabla-4' } },
  { name: 'Tabla 5', element: 'table', attributes: {'class': 'tabla-5' } },
  { name: 'Tabla 6', element: 'table', attributes: {'class': 'tabla-6' } },
  { name: 'Tabla 7', element: 'table', attributes: {'class': 'tabla-7' } },
  { name: 'Tabla 8', element: 'table', attributes: {'class': 'tabla-8' } },
  ...
  { name: 'Celda 7', element: 'td', attributes: {'class': 'celda-7' } },
  { name: 'Celda 8', element: 'td', attributes: {'class': 'celda-8' } },
  { name: 'Celda 9', element: 'td', attributes: {'class': 'celda-9' } },
  { name: 'Celda 10', element: 'td', attributes: {'class': 'celda-10' } },
  { name: 'Celda 11', element: 'td', attributes: {'class': 'celda-11' } },
  { name: 'Celda 12', element: 'td', attributes: {'class': 'celda-12' } },
  { name: 'Celda 13', element: 'td', attributes: {'class': 'celda-13' } },
  { name: 'Celda 14', element: 'td', attributes: {'class': 'celda-14' } },
  { name: 'Celda 15', element: 'td', attributes: {'class': 'celda-15' } },
  { name: 'Celda 16', element: 'td', attributes: {'class': 'celda-16' } },
  { name: 'Celda 17', element: 'td', attributes: {'class': 'celda-17' } },
  { name: 'Celda 18', element: 'td', attributes: {'class': 'celda-18' } },
  { name: 'Celda 19', element: 'td', attributes: {'class': 'celda-19' } },
...
/***/ "./bloggersdemo/blink-src/js/layout/main.js":
/*!*********************************************!*\
  !*** ./bloggersdemo/blink-src/js/layout/main.js ***!
  \*********************************************/
/*! exports provided: default */
...
/***/ "./bloggersdemo/blink-src/js/main.js":
/*!**************************************!*\
  !*** ./bloggersdemo/blink-src/js/main.js ***!
  \**************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _cke_styles__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cke_styles */ "./bloggersdemo/blink-src/js/cke_styles.js");
/* harmony import */ var _overrides__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./overrides */ "./bloggersdemo/blink-src/js/overrides.js");
/* harmony import */ var _layout_main__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./layout/main */ "./bloggersdemo/blink-src/js/layout/main.js");
/*
...
(function (blink) {
  ...
  BloggersdemoStyle.prototype = {
    ...
    bodyClassName: 'content_type_clase_bloggersdemo',
    extraPlugins: ['image2'],
    ckEditorStyles: {
      name: 'bloggersdemo',
  ...
  blink.theme.styles['bloggersdemo'] = BloggersdemoStyle;
})(blink);

/***/ }),

/***/ "./bloggersdemo/blink-src/js/overrides.js":
/*!*******************************************!*\
  !*** ./bloggersdemo/blink-src/js/overrides.js ***!
  \*******************************************/
/*! exports provided: default */
...
/***/ "./bloggersdemo/blink-src/styles/main.scss":
/*!********************************************!*\
  !*** ./bloggersdemo/blink-src/styles/main.scss ***!
  \********************************************/
...
/***/ 0:
/*!*********************************************************************************!*\
  !*** multi ./bloggersdemo/blink-src/js/main.js ./bloggersdemo/blink-src/styles/main.scss ***!
  \*********************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! D:\workspaces\web\blinkweb\blink\www\themes\responsive\assets\styles\bloggersdemo\blink-src\js\main.js */"./bloggersdemo/blink-src/js/main.js");
module.exports = __webpack_require__(/*! D:\workspaces\web\blinkweb\blink\www\themes\responsive\assets\styles\bloggersdemo\blink-src\styles\main.scss */"./bloggersdemo/blink-src/styles/main.scss");
